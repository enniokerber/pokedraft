...
import {LeagueSnippetListComponent} from './leagues/league-snippet-list/league-snippet-list.component';
import {LeagueSnippetContainerComponent} from './leagues/league-snippet-list/league-snippet-container/league-snippet-container.component';


@NgModule({
  declarations: [ProfileComponent, LeaguesComponent, ProfileNavbarComponent, AccountComponent, FileUploadComponent, FilesComponent, FileListComponent, LeagueListComponent, LeagueContainerComponent, UploadTaskComponent, ChooseFileComponent, UsersLeaguesComponent, CreateLeagueComponent, HallOfFameComponent, AchievementComponent, EnterLeagueComponent, MessagesComponent, MessageContainerComponent, AchievementListComponent, AdminToolboxComponent, LeagueSnippetListComponent, LeagueSnippetContainerComponent],
  imports: [
    CommonModule,
